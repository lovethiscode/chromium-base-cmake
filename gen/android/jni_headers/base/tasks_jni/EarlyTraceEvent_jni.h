...
inline jclass org_chromium_base_EarlyTraceEvent_clazz(JNIEnv* env) {
  static const char kClassName[] = "org/chromium/base/EarlyTraceEvent";
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1EarlyTraceEvent_1recordEarlyAsyncBeginEvent(
    JNIEnv* env,
    jclass jcaller,
    jobject name,
    jlong id,
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1EarlyTraceEvent_1recordEarlyAsyncEndEvent(
    JNIEnv* env,
    jclass jcaller,
    jlong id,
    jlong timeNanos) {
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1EarlyTraceEvent_1recordEarlyBeginEvent(
    JNIEnv* env,
    jclass jcaller,
    jobject name,
    jlong timeNanos,
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1EarlyTraceEvent_1recordEarlyEndEvent(
    JNIEnv* env,
    jclass jcaller,
    jobject name,
    jlong timeNanos,
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1EarlyTraceEvent_1recordEarlyToplevelBeginEvent(
    JNIEnv* env,
    jclass jcaller,
    jobject name,
    jlong timeNanos,
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1EarlyTraceEvent_1recordEarlyToplevelEndEvent(
    JNIEnv* env,
    jclass jcaller,
    jobject name,
    jlong timeNanos,
...
static jboolean Java_EarlyTraceEvent_getBackgroundStartupTracingFlag(
    JNIEnv* env) {
...
static void Java_EarlyTraceEvent_setBackgroundStartupTracingFlag(
    JNIEnv* env,
    jboolean enabled) {
  static std::atomic<jmethodID> cached_method_id(nullptr);
  jclass clazz = org_chromium_base_EarlyTraceEvent_clazz(env);
