...
inline jclass org_chromium_base_JavaHandlerThread_clazz(JNIEnv* env) {
  static const char kClassName[] = "org/chromium/base/JavaHandlerThread";
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1JavaHandlerThread_1initializeThread(
    JNIEnv* env,
    jclass jcaller,
...
JNI_POSSIBLE_BOUNDARY_EXPORT void Java_org_jni_1zero_GEN_1JNI_org_1chromium_1base_1JavaHandlerThread_1onLooperStopped(
    JNIEnv* env,
    jclass jcaller,
    jlong nativeJavaHandlerThread) {
  reinterpret_cast<JavaHandlerThread*>(nativeJavaHandlerThread)->OnLooperStopped(
      env);
}
...
static jni_zero::ScopedJavaLocalRef<jobject> Java_JavaHandlerThread_create(
  ...
  call_context.Init<jni_zero::MethodID::TYPE_STATIC>(
      ...
      &cached_method_id);
  jni_zero::ScopedJavaLocalRef<jobject> converted_name = jni_zero::ToJniType(
      env,
      name);
...
static jboolean Java_JavaHandlerThread_isAlive(
    JNIEnv* env,
    const jni_zero::JavaRef<jobject>& obj) {
  static std::atomic<jmethodID> cached_method_id(nullptr);
  jclass clazz = org_chromium_base_JavaHandlerThread_clazz(env);
...
static void Java_JavaHandlerThread_joinThread(
    JNIEnv* env,
    const jni_zero::JavaRef<jobject>& obj) {
  static std::atomic<jmethodID> cached_method_id(nullptr);
  jclass clazz = org_chromium_base_JavaHandlerThread_clazz(env);
