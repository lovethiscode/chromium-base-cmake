...
class PERFETTO_EXPORT_COMPONENT ChromeEventBundle : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT ChromeStringTableEntry : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kValueFieldNumber = 1,
    kIndexFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT ChromeLegacyJsonTrace : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT ChromeMetadata : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT ChromeTraceEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT ChromeTraceEvent_Arg : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT ChromeTracedValue : public ::protozero::CppMessageObj {
 public:
