...
class PERFETTO_EXPORT_COMPONENT PowerRails : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT PowerRails_EnergyData : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIndexFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT PowerRails_RailDescriptor : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIndexFieldNumber = 1,
