...
struct AndroidSystemProperty_PropertyValueDefaultTypeInternal {
  PROTOBUF_CONSTEXPR AndroidSystemProperty_PropertyValueDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidSystemProperty_PropertyValueDefaultTypeInternal _AndroidSystemProperty_PropertyValue_default_instance_;
PROTOBUF_CONSTEXPR AndroidSystemProperty::AndroidSystemProperty(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.values_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct AndroidSystemPropertyDefaultTypeInternal {
  PROTOBUF_CONSTEXPR AndroidSystemPropertyDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidSystemPropertyDefaultTypeInternal _AndroidSystemProperty_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
inline void AndroidSystemProperty_PropertyValue::SharedCtor(
...
void AndroidSystemProperty_PropertyValue::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const AndroidSystemProperty_PropertyValue*>(
      &from));
}

void AndroidSystemProperty_PropertyValue::MergeFrom(const AndroidSystemProperty_PropertyValue& from) {
...
std::string AndroidSystemProperty_PropertyValue::GetTypeName() const {
...
inline void AndroidSystemProperty::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
void AndroidSystemProperty::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const AndroidSystemProperty*>(
      &from));
}

void AndroidSystemProperty::MergeFrom(const AndroidSystemProperty& from) {
...
std::string AndroidSystemProperty::GetTypeName() const {
