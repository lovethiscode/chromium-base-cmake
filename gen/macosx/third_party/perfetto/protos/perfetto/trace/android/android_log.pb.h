...
class AndroidLogPacket_LogEvent_Arg final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket_LogEvent_Arg* other) {
...
class AndroidLogPacket_LogEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket_LogEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class AndroidLogPacket_Stats final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket_Stats* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class AndroidLogPacket final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
