...
class PERFETTO_EXPORT_COMPONENT PackagesList : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT PackagesList_PackageInfo : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
    kUidFieldNumber = 2,
