...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot_ProcessSnapshot : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot_ProcessSnapshot_MemoryEdge : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot_ProcessSnapshot_MemoryNode : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot_ProcessSnapshot_MemoryNode_MemoryNodeEntry : public ::protozero::CppMessageObj {
 public:
