...
class PerfettoMetatrace_Arg final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PerfettoMetatrace_Arg* other) {
...
class PerfettoMetatrace_InternedString final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PerfettoMetatrace_InternedString* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class PerfettoMetatrace final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PerfettoMetatrace* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
