...
class PERFETTO_EXPORT_COMPONENT DeobfuscationMapping : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT ObfuscatedClass : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT ObfuscatedMember : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kObfuscatedNameFieldNumber = 1,
    kDeobfuscatedNameFieldNumber = 2,
