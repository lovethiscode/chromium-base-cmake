...
class PERFETTO_EXPORT_COMPONENT HeapGraph : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPidFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT HeapGraphType : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT HeapGraphRoot : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT HeapGraphObject : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIdFieldNumber = 1,
  ...
  bool has_id_delta() const { return _has_field_[7]; }
  uint64_t id_delta() const { return id_delta_; }
  void set_id_delta(uint64_t value) { id_delta_ = value; _has_field_.set(7); }
  ...
  bool has_native_allocation_registry_size_field() const { return _has_field_[8]; }
  int64_t native_allocation_registry_size_field() const { return native_allocation_registry_size_field_; }
  void set_native_allocation_registry_size_field(int64_t value) { native_allocation_registry_size_field_ = value; _has_field_.set(8); }
