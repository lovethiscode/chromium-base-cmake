...
class PERFETTO_EXPORT_COMPONENT VulkanMemoryEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT VulkanMemoryEventAnnotation : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
