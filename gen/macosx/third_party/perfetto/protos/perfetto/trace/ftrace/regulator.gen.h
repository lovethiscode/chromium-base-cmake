...
class PERFETTO_EXPORT_COMPONENT RegulatorSetVoltageCompleteFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
    kValFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT RegulatorSetVoltageFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
    kMinFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT RegulatorEnableDelayFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT RegulatorEnableCompleteFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT RegulatorEnableFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT RegulatorDisableCompleteFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT RegulatorDisableFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
