...
class PERFETTO_EXPORT_COMPONENT BinderReturnFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCmdFieldNumber = 1,
  };
  ...
  BinderReturnFtraceEvent(BinderReturnFtraceEvent&&) noexcept;
  BinderReturnFtraceEvent& operator=(BinderReturnFtraceEvent&&);
  BinderReturnFtraceEvent(const BinderReturnFtraceEvent&);
  BinderReturnFtraceEvent& operator=(const BinderReturnFtraceEvent&);
  bool operator==(const BinderReturnFtraceEvent&) const;
  bool operator!=(const BinderReturnFtraceEvent& other) const { return !(*this == other); }
...
class PERFETTO_EXPORT_COMPONENT BinderCommandFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCmdFieldNumber = 1,
  };
  ...
  BinderCommandFtraceEvent(BinderCommandFtraceEvent&&) noexcept;
  BinderCommandFtraceEvent& operator=(BinderCommandFtraceEvent&&);
  BinderCommandFtraceEvent(const BinderCommandFtraceEvent&);
  BinderCommandFtraceEvent& operator=(const BinderCommandFtraceEvent&);
  bool operator==(const BinderCommandFtraceEvent&) const;
  bool operator!=(const BinderCommandFtraceEvent& other) const { return !(*this == other); }
...
class PERFETTO_EXPORT_COMPONENT BinderTransactionAllocBufFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
  ...
  bool has_extra_buffers_size() const { return _has_field_[4]; }
  uint64_t extra_buffers_size() const { return extra_buffers_size_; }
  void set_extra_buffers_size(uint64_t value) { extra_buffers_size_ = value; _has_field_.set(4); }
...
class PERFETTO_EXPORT_COMPONENT BinderUnlockFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kTagFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT BinderLockedFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kTagFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT BinderLockFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kTagFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT BinderSetPriorityFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kProcFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT BinderTransactionReceivedFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT BinderTransactionFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kDebugIdFieldNumber = 1,
