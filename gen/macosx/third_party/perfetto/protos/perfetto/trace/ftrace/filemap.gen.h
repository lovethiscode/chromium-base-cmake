...
class PERFETTO_EXPORT_COMPONENT MmFilemapDeleteFromPageCacheFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPfnFieldNumber = 1,
    kIInoFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT MmFilemapAddToPageCacheFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPfnFieldNumber = 1,
    kIInoFieldNumber = 2,
