...
class PERFETTO_EXPORT_COMPONENT SignalGenerateFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCodeFieldNumber = 1,
    kCommFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT SignalDeliverFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCodeFieldNumber = 1,
