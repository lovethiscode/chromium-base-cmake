...
struct DmaHeapStatFtraceEventDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DmaHeapStatFtraceEventDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DmaHeapStatFtraceEventDefaultTypeInternal _DmaHeapStatFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
DmaHeapStatFtraceEvent::DmaHeapStatFtraceEvent(const DmaHeapStatFtraceEvent& from)
  ...
  DmaHeapStatFtraceEvent* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void DmaHeapStatFtraceEvent::SharedCtor(
...
void DmaHeapStatFtraceEvent::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const DmaHeapStatFtraceEvent*>(
      &from));
}

void DmaHeapStatFtraceEvent::MergeFrom(const DmaHeapStatFtraceEvent& from) {
  DmaHeapStatFtraceEvent* const _this = this;
