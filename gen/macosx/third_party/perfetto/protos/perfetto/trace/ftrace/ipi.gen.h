...
class PERFETTO_EXPORT_COMPONENT IpiRaiseFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT IpiExitFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT IpiEntryFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kReasonFieldNumber = 1,
  };
