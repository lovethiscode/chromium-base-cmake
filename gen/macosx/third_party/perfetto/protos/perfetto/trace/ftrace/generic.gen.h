...
class PERFETTO_EXPORT_COMPONENT GenericFtraceEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT GenericFtraceEvent_Field : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
