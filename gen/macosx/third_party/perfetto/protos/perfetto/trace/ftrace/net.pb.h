...
class NetifReceiveSkbFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(NetifReceiveSkbFtraceEvent* other) {
...
class NetDevXmitFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(NetDevXmitFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class NapiGroReceiveEntryFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(NapiGroReceiveEntryFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class NapiGroReceiveExitFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(NapiGroReceiveExitFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
