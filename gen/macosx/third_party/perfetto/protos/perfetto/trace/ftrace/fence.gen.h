...
class PERFETTO_EXPORT_COMPONENT FenceSignaledFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT FenceEnableSignalFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kContextFieldNumber = 1,
    kDriverFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT FenceDestroyFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kContextFieldNumber = 1,
    kDriverFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT FenceInitFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kContextFieldNumber = 1,
    kDriverFieldNumber = 2,
