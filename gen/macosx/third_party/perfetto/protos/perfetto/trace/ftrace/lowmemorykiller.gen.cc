...
bool LowmemoryKillFtraceEvent::operator==(const LowmemoryKillFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   ...
   && ::protozero::internal::gen_helpers::EqualsField(pagecache_size_, other.pagecache_size_)
   && ::protozero::internal::gen_helpers::EqualsField(pagecache_limit_, other.pagecache_limit_)
