...
class PERFETTO_EXPORT_COMPONENT InodeFileMap : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT InodeFileMap_Entry : public ::protozero::CppMessageObj {
 public:
