...
R"_d3l1m1t3r_(JOIN heap_graph_object obj USING(id)
UNION ALL
...
R"_d3l1m1t3r_(  SUM(IIF(marked, dominated_obj_count, 0)) AS dominated_obj_count,
...
R"_d3l1m1t3r_(      'dominated_obj_count', dominated_obj_count,
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW java_heap_span AS
