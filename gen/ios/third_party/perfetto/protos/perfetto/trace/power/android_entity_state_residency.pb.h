...
class EntityStateResidency_PowerEntityState final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(EntityStateResidency_PowerEntityState* other) {
...
class EntityStateResidency_StateResidency final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(EntityStateResidency_StateResidency* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class EntityStateResidency final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(EntityStateResidency* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
