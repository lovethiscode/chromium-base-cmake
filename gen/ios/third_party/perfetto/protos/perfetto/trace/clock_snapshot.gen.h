...
class PERFETTO_EXPORT_COMPONENT ClockSnapshot : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT ClockSnapshot_Clock : public ::protozero::CppMessageObj {
 public:
