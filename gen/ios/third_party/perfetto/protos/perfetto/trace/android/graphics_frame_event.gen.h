...
class PERFETTO_EXPORT_COMPONENT GraphicsFrameEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT GraphicsFrameEvent_BufferEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
