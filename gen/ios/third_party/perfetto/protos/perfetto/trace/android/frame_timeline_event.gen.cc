...
bool FrameTimelineEvent::operator==(const FrameTimelineEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   && ::protozero::internal::gen_helpers::EqualsField(expected_display_frame_start_, other.expected_display_frame_start_)
   && ::protozero::internal::gen_helpers::EqualsField(actual_display_frame_start_, other.actual_display_frame_start_)
   && ::protozero::internal::gen_helpers::EqualsField(expected_surface_frame_start_, other.expected_surface_frame_start_)
   && ::protozero::internal::gen_helpers::EqualsField(actual_surface_frame_start_, other.actual_surface_frame_start_)
   && ::protozero::internal::gen_helpers::EqualsField(frame_end_, other.frame_end_);
}
...
bool FrameTimelineEvent_FrameEnd::operator==(const FrameTimelineEvent_FrameEnd& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   && ::protozero::internal::gen_helpers::EqualsField(cookie_, other.cookie_);
}
...
bool FrameTimelineEvent_ActualSurfaceFrameStart::operator==(const FrameTimelineEvent_ActualSurfaceFrameStart& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   ...
   && ::protozero::internal::gen_helpers::EqualsField(display_frame_token_, other.display_frame_token_)
   ...
   && ::protozero::internal::gen_helpers::EqualsField(present_type_, other.present_type_)
