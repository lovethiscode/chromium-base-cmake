...
class PERFETTO_EXPORT_COMPONENT AndroidLogPacket : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT AndroidLogPacket_Stats : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT AndroidLogPacket_LogEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT AndroidLogPacket_LogEvent_Arg : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
