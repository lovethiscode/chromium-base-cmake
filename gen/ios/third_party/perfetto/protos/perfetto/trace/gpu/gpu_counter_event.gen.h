...
class PERFETTO_EXPORT_COMPONENT GpuCounterEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT GpuCounterEvent_GpuCounter : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
