...
class PERFETTO_EXPORT_COMPONENT VulkanApiEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT VulkanApiEvent_VkQueueSubmit : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT VulkanApiEvent_VkDebugUtilsObjectName : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPidFieldNumber = 1,
