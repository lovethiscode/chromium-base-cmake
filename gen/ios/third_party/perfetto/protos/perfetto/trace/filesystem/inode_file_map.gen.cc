...
bool InodeFileMap::operator==(const InodeFileMap& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   && ::protozero::internal::gen_helpers::EqualsField(block_device_id_, other.block_device_id_)
   && ::protozero::internal::gen_helpers::EqualsField(mount_points_, other.mount_points_)
...
bool InodeFileMap_Entry::operator==(const InodeFileMap_Entry& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   && ::protozero::internal::gen_helpers::EqualsField(inode_number_, other.inode_number_)
   && ::protozero::internal::gen_helpers::EqualsField(paths_, other.paths_)
