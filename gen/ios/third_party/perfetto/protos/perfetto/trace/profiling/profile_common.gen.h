...
class PERFETTO_EXPORT_COMPONENT Callstack : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIidFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT Frame : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIidFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT ModuleSymbols : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPathFieldNumber = 1,
    kBuildIdFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT AddressSymbols : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT ProfiledFrameSymbols : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT InternedString : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIidFieldNumber = 1,
    kStrFieldNumber = 2,
