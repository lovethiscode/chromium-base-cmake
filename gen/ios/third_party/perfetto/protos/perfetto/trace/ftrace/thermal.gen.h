...
class PERFETTO_EXPORT_COMPONENT CdevUpdateFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT ThermalTemperatureFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIdFieldNumber = 1,
    kTempFieldNumber = 2,
