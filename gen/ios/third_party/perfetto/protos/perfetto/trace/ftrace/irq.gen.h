...
class PERFETTO_EXPORT_COMPONENT IrqHandlerExitFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIrqFieldNumber = 1,
    kRetFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT IrqHandlerEntryFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIrqFieldNumber = 1,
    kNameFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT SoftirqRaiseFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kVecFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT SoftirqExitFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kVecFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT SoftirqEntryFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kVecFieldNumber = 1,
  };
