...
class PERFETTO_EXPORT_COMPONENT FtraceEvent : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_dpu_dsi_cmd_fifo_status() const { return _has_field_[492]; }
  const DpuDsiCmdFifoStatusFtraceEvent& dpu_dsi_cmd_fifo_status() const { return *dpu_dsi_cmd_fifo_status_; }
  DpuDsiCmdFifoStatusFtraceEvent* mutable_dpu_dsi_cmd_fifo_status() { _has_field_.set(492); return dpu_dsi_cmd_fifo_status_.get(); }

  bool has_dpu_dsi_rx() const { return _has_field_[493]; }
  const DpuDsiRxFtraceEvent& dpu_dsi_rx() const { return *dpu_dsi_rx_; }
  DpuDsiRxFtraceEvent* mutable_dpu_dsi_rx() { _has_field_.set(493); return dpu_dsi_rx_.get(); }

  bool has_dpu_dsi_tx() const { return _has_field_[494]; }
  const DpuDsiTxFtraceEvent& dpu_dsi_tx() const { return *dpu_dsi_tx_; }
  DpuDsiTxFtraceEvent* mutable_dpu_dsi_tx() { _has_field_.set(494); return dpu_dsi_tx_.get(); }

  bool has_f2fs_background_gc() const { return _has_field_[495]; }
  const F2fsBackgroundGcFtraceEvent& f2fs_background_gc() const { return *f2fs_background_gc_; }
  F2fsBackgroundGcFtraceEvent* mutable_f2fs_background_gc() { _has_field_.set(495); return f2fs_background_gc_.get(); }

  bool has_f2fs_gc_begin() const { return _has_field_[496]; }
  const F2fsGcBeginFtraceEvent& f2fs_gc_begin() const { return *f2fs_gc_begin_; }
  F2fsGcBeginFtraceEvent* mutable_f2fs_gc_begin() { _has_field_.set(496); return f2fs_gc_begin_.get(); }

  bool has_f2fs_gc_end() const { return _has_field_[497]; }
  const F2fsGcEndFtraceEvent& f2fs_gc_end() const { return *f2fs_gc_end_; }
  F2fsGcEndFtraceEvent* mutable_f2fs_gc_end() { _has_field_.set(497); return f2fs_gc_end_.get(); }

  bool has_fastrpc_dma_free() const { return _has_field_[498]; }
  const FastrpcDmaFreeFtraceEvent& fastrpc_dma_free() const { return *fastrpc_dma_free_; }
  FastrpcDmaFreeFtraceEvent* mutable_fastrpc_dma_free() { _has_field_.set(498); return fastrpc_dma_free_.get(); }

  bool has_fastrpc_dma_alloc() const { return _has_field_[499]; }
  const FastrpcDmaAllocFtraceEvent& fastrpc_dma_alloc() const { return *fastrpc_dma_alloc_; }
  FastrpcDmaAllocFtraceEvent* mutable_fastrpc_dma_alloc() { _has_field_.set(499); return fastrpc_dma_alloc_.get(); }

  bool has_fastrpc_dma_unmap() const { return _has_field_[500]; }
  const FastrpcDmaUnmapFtraceEvent& fastrpc_dma_unmap() const { return *fastrpc_dma_unmap_; }
  FastrpcDmaUnmapFtraceEvent* mutable_fastrpc_dma_unmap() { _has_field_.set(500); return fastrpc_dma_unmap_.get(); }

  bool has_fastrpc_dma_map() const { return _has_field_[501]; }
  const FastrpcDmaMapFtraceEvent& fastrpc_dma_map() const { return *fastrpc_dma_map_; }
  FastrpcDmaMapFtraceEvent* mutable_fastrpc_dma_map() { _has_field_.set(501); return fastrpc_dma_map_.get(); }

  bool has_google_icc_event() const { return _has_field_[502]; }
  const GoogleIccEventFtraceEvent& google_icc_event() const { return *google_icc_event_; }
  GoogleIccEventFtraceEvent* mutable_google_icc_event() { _has_field_.set(502); return google_icc_event_.get(); }

  bool has_google_irm_event() const { return _has_field_[503]; }
  const GoogleIrmEventFtraceEvent& google_irm_event() const { return *google_irm_event_; }
  GoogleIrmEventFtraceEvent* mutable_google_irm_event() { _has_field_.set(503); return google_irm_event_.get(); }

  bool has_device_pm_callback_start() const { return _has_field_[504]; }
  const DevicePmCallbackStartFtraceEvent& device_pm_callback_start() const { return *device_pm_callback_start_; }
  DevicePmCallbackStartFtraceEvent* mutable_device_pm_callback_start() { _has_field_.set(504); return device_pm_callback_start_.get(); }

  bool has_device_pm_callback_end() const { return _has_field_[505]; }
  const DevicePmCallbackEndFtraceEvent& device_pm_callback_end() const { return *device_pm_callback_end_; }
  DevicePmCallbackEndFtraceEvent* mutable_device_pm_callback_end() { _has_field_.set(505); return device_pm_callback_end_.get(); }

  bool has_thermal_exynos_acpm_bulk() const { return _has_field_[506]; }
  const ThermalExynosAcpmBulkFtraceEvent& thermal_exynos_acpm_bulk() const { return *thermal_exynos_acpm_bulk_; }
  ThermalExynosAcpmBulkFtraceEvent* mutable_thermal_exynos_acpm_bulk() { _has_field_.set(506); return thermal_exynos_acpm_bulk_.get(); }

  bool has_thermal_exynos_acpm_high_overhead() const { return _has_field_[507]; }
  const ThermalExynosAcpmHighOverheadFtraceEvent& thermal_exynos_acpm_high_overhead() const { return *thermal_exynos_acpm_high_overhead_; }
  ThermalExynosAcpmHighOverheadFtraceEvent* mutable_thermal_exynos_acpm_high_overhead() { _has_field_.set(507); return thermal_exynos_acpm_high_overhead_.get(); }

  bool has_dcvsh_freq() const { return _has_field_[508]; }
  const DcvshFreqFtraceEvent& dcvsh_freq() const { return *dcvsh_freq_; }
  DcvshFreqFtraceEvent* mutable_dcvsh_freq() { _has_field_.set(508); return dcvsh_freq_.get(); }

  bool has_kgsl_gpu_frequency() const { return _has_field_[509]; }
  const KgslGpuFrequencyFtraceEvent& kgsl_gpu_frequency() const { return *kgsl_gpu_frequency_; }
  KgslGpuFrequencyFtraceEvent* mutable_kgsl_gpu_frequency() { _has_field_.set(509); return kgsl_gpu_frequency_.get(); }

  bool has_mali_mali_pm_mcu_hctl_cores_down_scale_notify_pend() const { return _has_field_[510]; }
  const MaliMaliPMMCUHCTLCORESDOWNSCALENOTIFYPENDFtraceEvent& mali_mali_pm_mcu_hctl_cores_down_scale_notify_pend() const { return *mali_mali_pm_mcu_hctl_cores_down_scale_notify_pend_; }
  MaliMaliPMMCUHCTLCORESDOWNSCALENOTIFYPENDFtraceEvent* mutable_mali_mali_pm_mcu_hctl_cores_down_scale_notify_pend() { _has_field_.set(510); return mali_mali_pm_mcu_hctl_cores_down_scale_notify_pend_.get(); }

  bool has_mali_mali_pm_mcu_hctl_cores_notify_pend() const { return _has_field_[511]; }
  const MaliMaliPMMCUHCTLCORESNOTIFYPENDFtraceEvent& mali_mali_pm_mcu_hctl_cores_notify_pend() const { return *mali_mali_pm_mcu_hctl_cores_notify_pend_; }
  MaliMaliPMMCUHCTLCORESNOTIFYPENDFtraceEvent* mutable_mali_mali_pm_mcu_hctl_cores_notify_pend() { _has_field_.set(511); return mali_mali_pm_mcu_hctl_cores_notify_pend_.get(); }

  bool has_mali_mali_pm_mcu_hctl_core_inactive_pend() const { return _has_field_[512]; }
  const MaliMaliPMMCUHCTLCOREINACTIVEPENDFtraceEvent& mali_mali_pm_mcu_hctl_core_inactive_pend() const { return *mali_mali_pm_mcu_hctl_core_inactive_pend_; }
  MaliMaliPMMCUHCTLCOREINACTIVEPENDFtraceEvent* mutable_mali_mali_pm_mcu_hctl_core_inactive_pend() { _has_field_.set(512); return mali_mali_pm_mcu_hctl_core_inactive_pend_.get(); }

  bool has_mali_mali_pm_mcu_hctl_mcu_on_recheck() const { return _has_field_[513]; }
  const MaliMaliPMMCUHCTLMCUONRECHECKFtraceEvent& mali_mali_pm_mcu_hctl_mcu_on_recheck() const { return *mali_mali_pm_mcu_hctl_mcu_on_recheck_; }
  MaliMaliPMMCUHCTLMCUONRECHECKFtraceEvent* mutable_mali_mali_pm_mcu_hctl_mcu_on_recheck() { _has_field_.set(513); return mali_mali_pm_mcu_hctl_mcu_on_recheck_.get(); }

  bool has_mali_mali_pm_mcu_hctl_shaders_core_off_pend() const { return _has_field_[514]; }
  const MaliMaliPMMCUHCTLSHADERSCOREOFFPENDFtraceEvent& mali_mali_pm_mcu_hctl_shaders_core_off_pend() const { return *mali_mali_pm_mcu_hctl_shaders_core_off_pend_; }
  MaliMaliPMMCUHCTLSHADERSCOREOFFPENDFtraceEvent* mutable_mali_mali_pm_mcu_hctl_shaders_core_off_pend() { _has_field_.set(514); return mali_mali_pm_mcu_hctl_shaders_core_off_pend_.get(); }

  bool has_mali_mali_pm_mcu_hctl_shaders_pend_off() const { return _has_field_[515]; }
  const MaliMaliPMMCUHCTLSHADERSPENDOFFFtraceEvent& mali_mali_pm_mcu_hctl_shaders_pend_off() const { return *mali_mali_pm_mcu_hctl_shaders_pend_off_; }
  MaliMaliPMMCUHCTLSHADERSPENDOFFFtraceEvent* mutable_mali_mali_pm_mcu_hctl_shaders_pend_off() { _has_field_.set(515); return mali_mali_pm_mcu_hctl_shaders_pend_off_.get(); }

  bool has_mali_mali_pm_mcu_hctl_shaders_pend_on() const { return _has_field_[516]; }
  const MaliMaliPMMCUHCTLSHADERSPENDONFtraceEvent& mali_mali_pm_mcu_hctl_shaders_pend_on() const { return *mali_mali_pm_mcu_hctl_shaders_pend_on_; }
  MaliMaliPMMCUHCTLSHADERSPENDONFtraceEvent* mutable_mali_mali_pm_mcu_hctl_shaders_pend_on() { _has_field_.set(516); return mali_mali_pm_mcu_hctl_shaders_pend_on_.get(); }

  bool has_mali_mali_pm_mcu_hctl_shaders_ready_off() const { return _has_field_[517]; }
  const MaliMaliPMMCUHCTLSHADERSREADYOFFFtraceEvent& mali_mali_pm_mcu_hctl_shaders_ready_off() const { return *mali_mali_pm_mcu_hctl_shaders_ready_off_; }
  MaliMaliPMMCUHCTLSHADERSREADYOFFFtraceEvent* mutable_mali_mali_pm_mcu_hctl_shaders_ready_off() { _has_field_.set(517); return mali_mali_pm_mcu_hctl_shaders_ready_off_.get(); }

  bool has_mali_mali_pm_mcu_in_sleep() const { return _has_field_[518]; }
  const MaliMaliPMMCUINSLEEPFtraceEvent& mali_mali_pm_mcu_in_sleep() const { return *mali_mali_pm_mcu_in_sleep_; }
  MaliMaliPMMCUINSLEEPFtraceEvent* mutable_mali_mali_pm_mcu_in_sleep() { _has_field_.set(518); return mali_mali_pm_mcu_in_sleep_.get(); }

  bool has_mali_mali_pm_mcu_off() const { return _has_field_[519]; }
  const MaliMaliPMMCUOFFFtraceEvent& mali_mali_pm_mcu_off() const { return *mali_mali_pm_mcu_off_; }
  MaliMaliPMMCUOFFFtraceEvent* mutable_mali_mali_pm_mcu_off() { _has_field_.set(519); return mali_mali_pm_mcu_off_.get(); }

  bool has_mali_mali_pm_mcu_on() const { return _has_field_[520]; }
  const MaliMaliPMMCUONFtraceEvent& mali_mali_pm_mcu_on() const { return *mali_mali_pm_mcu_on_; }
  MaliMaliPMMCUONFtraceEvent* mutable_mali_mali_pm_mcu_on() { _has_field_.set(520); return mali_mali_pm_mcu_on_.get(); }

  bool has_mali_mali_pm_mcu_on_core_attr_update_pend() const { return _has_field_[521]; }
  const MaliMaliPMMCUONCOREATTRUPDATEPENDFtraceEvent& mali_mali_pm_mcu_on_core_attr_update_pend() const { return *mali_mali_pm_mcu_on_core_attr_update_pend_; }
  MaliMaliPMMCUONCOREATTRUPDATEPENDFtraceEvent* mutable_mali_mali_pm_mcu_on_core_attr_update_pend() { _has_field_.set(521); return mali_mali_pm_mcu_on_core_attr_update_pend_.get(); }

  bool has_mali_mali_pm_mcu_on_glb_reinit_pend() const { return _has_field_[522]; }
  const MaliMaliPMMCUONGLBREINITPENDFtraceEvent& mali_mali_pm_mcu_on_glb_reinit_pend() const { return *mali_mali_pm_mcu_on_glb_reinit_pend_; }
  MaliMaliPMMCUONGLBREINITPENDFtraceEvent* mutable_mali_mali_pm_mcu_on_glb_reinit_pend() { _has_field_.set(522); return mali_mali_pm_mcu_on_glb_reinit_pend_.get(); }

  bool has_mali_mali_pm_mcu_on_halt() const { return _has_field_[523]; }
  const MaliMaliPMMCUONHALTFtraceEvent& mali_mali_pm_mcu_on_halt() const { return *mali_mali_pm_mcu_on_halt_; }
  MaliMaliPMMCUONHALTFtraceEvent* mutable_mali_mali_pm_mcu_on_halt() { _has_field_.set(523); return mali_mali_pm_mcu_on_halt_.get(); }

  bool has_mali_mali_pm_mcu_on_hwcnt_disable() const { return _has_field_[524]; }
  const MaliMaliPMMCUONHWCNTDISABLEFtraceEvent& mali_mali_pm_mcu_on_hwcnt_disable() const { return *mali_mali_pm_mcu_on_hwcnt_disable_; }
  MaliMaliPMMCUONHWCNTDISABLEFtraceEvent* mutable_mali_mali_pm_mcu_on_hwcnt_disable() { _has_field_.set(524); return mali_mali_pm_mcu_on_hwcnt_disable_.get(); }

  bool has_mali_mali_pm_mcu_on_hwcnt_enable() const { return _has_field_[525]; }
  const MaliMaliPMMCUONHWCNTENABLEFtraceEvent& mali_mali_pm_mcu_on_hwcnt_enable() const { return *mali_mali_pm_mcu_on_hwcnt_enable_; }
  MaliMaliPMMCUONHWCNTENABLEFtraceEvent* mutable_mali_mali_pm_mcu_on_hwcnt_enable() { _has_field_.set(525); return mali_mali_pm_mcu_on_hwcnt_enable_.get(); }

  bool has_mali_mali_pm_mcu_on_pend_halt() const { return _has_field_[526]; }
  const MaliMaliPMMCUONPENDHALTFtraceEvent& mali_mali_pm_mcu_on_pend_halt() const { return *mali_mali_pm_mcu_on_pend_halt_; }
  MaliMaliPMMCUONPENDHALTFtraceEvent* mutable_mali_mali_pm_mcu_on_pend_halt() { _has_field_.set(526); return mali_mali_pm_mcu_on_pend_halt_.get(); }

  bool has_mali_mali_pm_mcu_on_pend_sleep() const { return _has_field_[527]; }
  const MaliMaliPMMCUONPENDSLEEPFtraceEvent& mali_mali_pm_mcu_on_pend_sleep() const { return *mali_mali_pm_mcu_on_pend_sleep_; }
  MaliMaliPMMCUONPENDSLEEPFtraceEvent* mutable_mali_mali_pm_mcu_on_pend_sleep() { _has_field_.set(527); return mali_mali_pm_mcu_on_pend_sleep_.get(); }

  bool has_mali_mali_pm_mcu_on_sleep_initiate() const { return _has_field_[528]; }
  const MaliMaliPMMCUONSLEEPINITIATEFtraceEvent& mali_mali_pm_mcu_on_sleep_initiate() const { return *mali_mali_pm_mcu_on_sleep_initiate_; }
  MaliMaliPMMCUONSLEEPINITIATEFtraceEvent* mutable_mali_mali_pm_mcu_on_sleep_initiate() { _has_field_.set(528); return mali_mali_pm_mcu_on_sleep_initiate_.get(); }

  bool has_mali_mali_pm_mcu_pend_off() const { return _has_field_[529]; }
  const MaliMaliPMMCUPENDOFFFtraceEvent& mali_mali_pm_mcu_pend_off() const { return *mali_mali_pm_mcu_pend_off_; }
  MaliMaliPMMCUPENDOFFFtraceEvent* mutable_mali_mali_pm_mcu_pend_off() { _has_field_.set(529); return mali_mali_pm_mcu_pend_off_.get(); }

  bool has_mali_mali_pm_mcu_pend_on_reload() const { return _has_field_[530]; }
  const MaliMaliPMMCUPENDONRELOADFtraceEvent& mali_mali_pm_mcu_pend_on_reload() const { return *mali_mali_pm_mcu_pend_on_reload_; }
  MaliMaliPMMCUPENDONRELOADFtraceEvent* mutable_mali_mali_pm_mcu_pend_on_reload() { _has_field_.set(530); return mali_mali_pm_mcu_pend_on_reload_.get(); }

  bool has_mali_mali_pm_mcu_power_down() const { return _has_field_[531]; }
  const MaliMaliPMMCUPOWERDOWNFtraceEvent& mali_mali_pm_mcu_power_down() const { return *mali_mali_pm_mcu_power_down_; }
  MaliMaliPMMCUPOWERDOWNFtraceEvent* mutable_mali_mali_pm_mcu_power_down() { _has_field_.set(531); return mali_mali_pm_mcu_power_down_.get(); }

  bool has_mali_mali_pm_mcu_reset_wait() const { return _has_field_[532]; }
  const MaliMaliPMMCURESETWAITFtraceEvent& mali_mali_pm_mcu_reset_wait() const { return *mali_mali_pm_mcu_reset_wait_; }
  MaliMaliPMMCURESETWAITFtraceEvent* mutable_mali_mali_pm_mcu_reset_wait() { _has_field_.set(532); return mali_mali_pm_mcu_reset_wait_.get(); }

  bool has_bcl_irq_trigger() const { return _has_field_[533]; }
  const BclIrqTriggerFtraceEvent& bcl_irq_trigger() const { return *bcl_irq_trigger_; }
  BclIrqTriggerFtraceEvent* mutable_bcl_irq_trigger() { _has_field_.set(533); return bcl_irq_trigger_.get(); }
 ...
 private:
  ...
  ::protozero::CopyablePtr<DpuDsiCmdFifoStatusFtraceEvent> dpu_dsi_cmd_fifo_status_;
  ::protozero::CopyablePtr<DpuDsiRxFtraceEvent> dpu_dsi_rx_;
  ::protozero::CopyablePtr<DpuDsiTxFtraceEvent> dpu_dsi_tx_;
  ::protozero::CopyablePtr<F2fsBackgroundGcFtraceEvent> f2fs_background_gc_;
  ::protozero::CopyablePtr<F2fsGcBeginFtraceEvent> f2fs_gc_begin_;
  ::protozero::CopyablePtr<F2fsGcEndFtraceEvent> f2fs_gc_end_;
  ::protozero::CopyablePtr<FastrpcDmaFreeFtraceEvent> fastrpc_dma_free_;
  ::protozero::CopyablePtr<FastrpcDmaAllocFtraceEvent> fastrpc_dma_alloc_;
  ::protozero::CopyablePtr<FastrpcDmaUnmapFtraceEvent> fastrpc_dma_unmap_;
  ::protozero::CopyablePtr<FastrpcDmaMapFtraceEvent> fastrpc_dma_map_;
  ::protozero::CopyablePtr<GoogleIccEventFtraceEvent> google_icc_event_;
  ::protozero::CopyablePtr<GoogleIrmEventFtraceEvent> google_irm_event_;
  ::protozero::CopyablePtr<DevicePmCallbackStartFtraceEvent> device_pm_callback_start_;
  ::protozero::CopyablePtr<DevicePmCallbackEndFtraceEvent> device_pm_callback_end_;
  ::protozero::CopyablePtr<ThermalExynosAcpmBulkFtraceEvent> thermal_exynos_acpm_bulk_;
  ::protozero::CopyablePtr<ThermalExynosAcpmHighOverheadFtraceEvent> thermal_exynos_acpm_high_overhead_;
  ::protozero::CopyablePtr<DcvshFreqFtraceEvent> dcvsh_freq_;
  ::protozero::CopyablePtr<KgslGpuFrequencyFtraceEvent> kgsl_gpu_frequency_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLCORESDOWNSCALENOTIFYPENDFtraceEvent> mali_mali_pm_mcu_hctl_cores_down_scale_notify_pend_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLCORESNOTIFYPENDFtraceEvent> mali_mali_pm_mcu_hctl_cores_notify_pend_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLCOREINACTIVEPENDFtraceEvent> mali_mali_pm_mcu_hctl_core_inactive_pend_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLMCUONRECHECKFtraceEvent> mali_mali_pm_mcu_hctl_mcu_on_recheck_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLSHADERSCOREOFFPENDFtraceEvent> mali_mali_pm_mcu_hctl_shaders_core_off_pend_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLSHADERSPENDOFFFtraceEvent> mali_mali_pm_mcu_hctl_shaders_pend_off_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLSHADERSPENDONFtraceEvent> mali_mali_pm_mcu_hctl_shaders_pend_on_;
  ::protozero::CopyablePtr<MaliMaliPMMCUHCTLSHADERSREADYOFFFtraceEvent> mali_mali_pm_mcu_hctl_shaders_ready_off_;
  ::protozero::CopyablePtr<MaliMaliPMMCUINSLEEPFtraceEvent> mali_mali_pm_mcu_in_sleep_;
  ::protozero::CopyablePtr<MaliMaliPMMCUOFFFtraceEvent> mali_mali_pm_mcu_off_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONFtraceEvent> mali_mali_pm_mcu_on_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONCOREATTRUPDATEPENDFtraceEvent> mali_mali_pm_mcu_on_core_attr_update_pend_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONGLBREINITPENDFtraceEvent> mali_mali_pm_mcu_on_glb_reinit_pend_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONHALTFtraceEvent> mali_mali_pm_mcu_on_halt_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONHWCNTDISABLEFtraceEvent> mali_mali_pm_mcu_on_hwcnt_disable_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONHWCNTENABLEFtraceEvent> mali_mali_pm_mcu_on_hwcnt_enable_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONPENDHALTFtraceEvent> mali_mali_pm_mcu_on_pend_halt_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONPENDSLEEPFtraceEvent> mali_mali_pm_mcu_on_pend_sleep_;
  ::protozero::CopyablePtr<MaliMaliPMMCUONSLEEPINITIATEFtraceEvent> mali_mali_pm_mcu_on_sleep_initiate_;
  ::protozero::CopyablePtr<MaliMaliPMMCUPENDOFFFtraceEvent> mali_mali_pm_mcu_pend_off_;
  ::protozero::CopyablePtr<MaliMaliPMMCUPENDONRELOADFtraceEvent> mali_mali_pm_mcu_pend_on_reload_;
  ::protozero::CopyablePtr<MaliMaliPMMCUPOWERDOWNFtraceEvent> mali_mali_pm_mcu_power_down_;
  ::protozero::CopyablePtr<MaliMaliPMMCURESETWAITFtraceEvent> mali_mali_pm_mcu_reset_wait_;
  ::protozero::CopyablePtr<BclIrqTriggerFtraceEvent> bcl_irq_trigger_;

  // Allows to preserve unknown protobuf fields for compatibility
  // with future versions of .proto files.
  std::string unknown_fields_;

  std::bitset<534> _has_field_{};
};
