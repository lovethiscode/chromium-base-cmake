...
class PERFETTO_EXPORT_COMPONENT ClkSetRateFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
    kRateFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT ClkDisableFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT_COMPONENT ClkEnableFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
  };
