...
class SyncPtFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SyncPtFtraceEvent* other) {
...
class SyncTimelineFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SyncTimelineFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class SyncWaitFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SyncWaitFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
