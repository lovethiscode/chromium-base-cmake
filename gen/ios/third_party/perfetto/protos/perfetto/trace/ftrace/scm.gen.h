...
class PERFETTO_EXPORT_COMPONENT ScmCallEndFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
  };
...
class PERFETTO_EXPORT_COMPONENT ScmCallStartFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
