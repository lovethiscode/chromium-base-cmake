...
bool ScmCallStartFtraceEvent::operator==(const ScmCallStartFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   && ::protozero::internal::gen_helpers::EqualsField(arginfo_, other.arginfo_)
   && ::protozero::internal::gen_helpers::EqualsField(x0_, other.x0_)
   && ::protozero::internal::gen_helpers::EqualsField(x5_, other.x5_);
}
