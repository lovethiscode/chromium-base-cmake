...
class PERFETTO_EXPORT_COMPONENT TaskRenameFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPidFieldNumber = 1,
...
class PERFETTO_EXPORT_COMPONENT TaskNewtaskFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPidFieldNumber = 1,
    kCommFieldNumber = 2,
