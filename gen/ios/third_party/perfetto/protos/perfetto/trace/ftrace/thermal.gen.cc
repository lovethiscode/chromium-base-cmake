...
bool ThermalTemperatureFtraceEvent::operator==(const ThermalTemperatureFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
   ...
   && ::protozero::internal::gen_helpers::EqualsField(temp_, other.temp_)
   && ::protozero::internal::gen_helpers::EqualsField(temp_prev_, other.temp_prev_)
   && ::protozero::internal::gen_helpers::EqualsField(thermal_zone_, other.thermal_zone_);
}
