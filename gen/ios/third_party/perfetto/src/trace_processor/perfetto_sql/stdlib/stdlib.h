...
R"_d3l1m1t3r_(  WHERE idom_id = _heap_graph_super_root_fn()
  UNION ALL
...
R"_d3l1m1t3r_(CREATE PERFETTO TABLE heap_graph_dominator_tree(
...
const char kChromeScrollJankPredictorJank[] = R"_d3l1m1t3r_(-- Copyright 2024 The Chromium Authors
-- Use of this source code is governed by a BSD-style license that can be
-- found in the LICENSE file.
...
R"_d3l1m1t3r_(  -- Duration in which the counter is contant and idle state doesn't change.
  dur INT,
...
R"_d3l1m1t3r_(CREATE VIRTUAL TABLE _freq_idle_counters
USING span_join(
...
R"_d3l1m1t3r_(  -- The name of the "most-specific" child table containing this row.
  type STRING,
...
R"_d3l1m1t3r_(  irq_context UINT,
...
R"_d3l1m1t3r_(  -- traces). For multi-machine, join with the `cpu` table on `ucpu` to get the
  -- CPU identifier of each machine.
  cpu UINT,
  -- The thread this event was emitted on.
  utid UINT,
...
const char kVizCoreType[] = R"_d3l1m1t3r_(--
-- Copyright 2023 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(cores AS MATERIALIZED (
  SELECT cpu_index
...
const FileToSql kFileToSql[] = {
  ...
  {"chrome/scroll_jank/predictor_jank.sql", kChromeScrollJankPredictorJank},
  ...
  {"viz/core_type.sql", kVizCoreType},
